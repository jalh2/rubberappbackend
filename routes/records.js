...
const { insertRecord, getRecord, getRecords, deleteRecords,deleteOneRecord, getdailyRecords, getweeklyRecords, getmonthlyRecords } = require('../controllers/recordController')
